...
fragment LinksCollection on Menu {
 ...
 fragment NavLink on NavigationLink {title    pageLink {__typename ...PageLink ...EventLink ...FacilityLink ...TrainingLink}}

fragment PageLink on Page {title slug path}
fragment EventLink on Event {title slug path}
fragment FacilityLink on Facility {title slug path}
fragment TrainingLink on Training {title slug path}
